...
class AppConfig:
    ...
    APP_VERSION: str = "2026-01-21-v2.12.0"

    video_path: str = os.getenv("VIDEO_PATH", "C:\\Users\\Khaled\\Downloads\\21_01_2026\\file4.mp4")
    ...
    classification_model_version: str = os.getenv("CLASS_MODEL_VERSION", "v9.0")
