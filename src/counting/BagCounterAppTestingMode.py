...
class BagCounterAppTestingMode:
    """
    ...
    def __init__(
        ...
        if not IS_RDK:
            ...
            if config.opencv_testing_mode:
                ...
                use_testing_mode = True
                logger.info("[BagCounterApp] Testing mode auto-enabled (development mode on Windows)")
        ...
        if is_development:
            ...
            self.frame_source = FrameSourceFactory.create(
                "opencv",
                source=video_path,
                target_fps=None if use_testing_mode else 25.0,
            ...
            if IS_RDK:
                ...
                self.frame_source = FrameSourceFactory.create("ros2", target_fps=25.0)
        ...
        # Inline/queue mode selection for testing
        self.testing_mode = getattr(self.frame_source, "testing_mode", False)
